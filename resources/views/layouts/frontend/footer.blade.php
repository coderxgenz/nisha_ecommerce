...
<footer class="footer footer_type_1">
      ...
      <div class="row row-cols-lg-5 row-cols-2">
        ...
        <div class="footer-column footer-newsletter col-12 mb-4 mb-lg-0">
          ...
          <div class="mt-4 pt-3">
            ...
            <p class="mt-2">
              <img loading="lazy" src="{{url('assets/frontend/images/payment-options.png')}}" alt="Acceptable payment gateways" class="mw-100">
            </p>
          </div>
        </div><!-- /.footer-column -->
      </div><!-- /.row-cols-5 -->
    ...
    <div class="modal-dialog modal-fullscreen">
      <div class="sitemap d-flex">
        <div class="w-50 d-none d-lg-block">
          <img loading="lazy" src="{{url('assets/frontend/images/nav-bg.jpg')}}" alt="Site map" class="sitemap__bg">
              ...
              <div class="swiper-container js-swiper-slider"
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="{{url('assets/frontend/images/products/quickview_1.jpg')}}" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="{{url('assets/frontend/images/products/quickview_2.jpg')}}" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="{{url('assets/frontend/images/products/quickview_3.jpg')}}" alt="">
                  </div>
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" src="{{url('assets/frontend/images/products/quickview_4.jpg')}}" alt="">
                  </div>
                </div>
        ...
        <div class="row p-0 m-0">
          <div class="col-md-6 p-0 d-none d-md-block">
            <div class="newsletter-popup__bg h-100 w-100">
              <img loading="lazy" src="{{url('assets/frontend/images/newsletter-popup.jpg')}}" class="h-100 w-100 object-fit-cover d-block" alt="">
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="size-guide__wrapper">
            <div class="size-guide__image">
              <img loading="lazy" src="{{url('assets/frontend/images/size-guide.jpg')}}" alt="">
            </div>
  ...
  <script src="{{url('assets/frontend/js/countdown.js')}}"></script>
  <script src="{{url('assets/frontend/js/jquery.fancybox.js')}}"></script>
